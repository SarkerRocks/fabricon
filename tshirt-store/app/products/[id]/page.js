    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 24px' }}>
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--muted)', fontSize: '14px' }}>[ Product Image ]</p>
        </div>
        ...
        <div>
          ...
          <div style={{ marginBottom: '28px' }}>
            <p style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '0.1em', marginBottom: '12px' }}>
              COLORS
            </p>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <button
              onClick={() => {
                handleAddToCart()
                if (selectedSize) router.push('/cart')
              }}
              style={{
                flex: 1,
                minWidth: '200px',
